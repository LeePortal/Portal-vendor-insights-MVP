  ...
  template: `
    ...
    <div *ngIf="showUser" class="dl-modal">
      <div class="vm-card">
        ...
        <div style="font-size:12px;font-weight:700;margin:6px 0 4px">Restrict access <span class="muted" style="font-weight:400">— pre-filled from the company's defaults; this user is enforced on exactly these values (empty = all)</span></div>
...
export class VendorAdminComponent implements OnInit {
  ...
  // Seed the new user from the company's DEFAULTS (brands, perms, category/sub/state). These are only a
  // starting point — once saved, the user's own values are the single source of enforcement.
